...
void write_jal(Instruction instruction) {
  /* YOUR CODE HERE */
  int aux = get_jump_offset(instruction);
  printf(JAL_FORMAT, instruction.ujtype.rd , aux);
}
...
void print_store(char *name, Instruction instruction) {
  /* YOUR CODE HERE */
  int aux = get_store_offset(instruction);
  printf(MEM_FORMAT, name, instruction.stype.rs2, aux, instruction.stype.rs1);
}
...
void print_branch(char *name, Instruction instruction) {
  /* YOUR CODE HERE */
  int aux = get_jump_offset(instruction);
  printf(BRANCH_FORMAT, name, instruction.sbtype.rs1, instruction.sbtype.rs2, aux);
}
